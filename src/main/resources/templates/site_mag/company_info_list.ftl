...
<form name="form1" method="post" action="/Verwalter/company/info/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/company/info/edit?__VIEWSTATE=${__VIEWSTATE!""}"><i></i><span>新增</span></a></li>
...
<tbody>
    ...
    <#list content_page.content as content>
        <tr>
            ...
            <td>${content.id?c}</td>
            <td><a href="/Verwalter/company/info/edit?id=${content.id?c}&__VIEWSTATE=${__VIEWSTATE!""}">${content.title!""}</a></td>
            <td>${content.number!''}</td>
            <td>
                <input name="listSortId" type="text" value="${content.sortId!""}" id="listSortId" class="sort" onkeydown="return checkNumber(event);">
            </td>
            <td align="center">
                <a href="/Verwalter/company/info/edit?id=${content.id?c}&__VIEWSTATE=${__VIEWSTATE!""}">修改</a>
            </td>
        </tr>
    </#list>
    </#if>
