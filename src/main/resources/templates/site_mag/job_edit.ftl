...
<body class="mainbody">
<form method="post" action="/Verwalter/job/save" id="form1">
<div>
...
<!--导航栏-->
<div class="location">
    <a href="/Verwalter/company/info/list" class="back"><i></i><span>
        返回列表页</span></a> 
    ...
    <div id="id-first-tab" class="tab-content" style="display: block;">
        <dl>
            ...
            <dd>
                ...
                <span class="Validform_checktip">*岗位标题</span>
            </dd>
        </dl>
        <dl>
            <dt>排序数字</dt>
        ...
        <dl>
            <dt>SEO关健字</dt>
            <dd>
                <textarea name="seoKeywords" rows="1" cols="20" id="txtSeoKeywords" class="input" datatype="*0-255" sucmsg=" "><#if goods??>${goods.seoKeywords!""}</#if></textarea>
        ...
        <dl>
            <dt>SEO描述</dt>
            <dd>
                <textarea name="seoDescription" rows="1" cols="20" id="txtSeoDescription" class="input" datatype="*0-255" sucmsg=" "><#if goods??>${goods.seoDescription!""}</#if></textarea>
                <span class="Validform_checktip">255个字符以内</span>
            </dd>
        </dl>
    </div>
