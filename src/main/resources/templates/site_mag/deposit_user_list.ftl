...
<body class="mainbody">
<form name="form1" method="post" action="/Verwalter/order/setting/depositUser/list" id="form1">
<div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <#if deposit_user_page??>
        <#list deposit_user_page.content as item>
            <tr>
                <td align="center">
                ...
                <td><a href="/Verwalter/order/setting/depositUser/edit?id=${item.id?c}">${item.username!""}</a></td>
                ...
                <td align="center">
                    <a href="/Verwalter/order/setting/depositUser/edit?id=${item.id?c}">修改</a>
                </td>
              </tr>
        </#list>
    </#if>
...
<!--内容底部-->
<#assign PAGE_DATA=deposit_user_page />
