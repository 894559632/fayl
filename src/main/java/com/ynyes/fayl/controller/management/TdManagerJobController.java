...
@Controller
@RequestMapping(value = "/Verwalter/job/")
public class TdManagerJobController {
	...
	public String goodsListPost(Integer page, Integer size, String saleType, String property, String __EVENTTARGET,
		...
		if (null != keywords && !"".equals(keywords)) {
			Page<TdJob> goodsPage = tdJobService.findByTitleContainingOrderBySortIdAsc(keywords, page, size);
			map.addAttribute("content_page", goodsPage);
		} else {
			Page<TdJob> goodsPage = tdJobService.findAll(page, size);
			map.addAttribute("content_page", goodsPage);
		}
	...
	public String goodsEdit(Long id, String __EVENTTARGET, String __EVENTARGUMENT, String __VIEWSTATE, ModelMap map,
		...
		if (null != id) {
			TdJob tdGoods = tdJobService.findOne(id);
			map.addAttribute("goods", tdGoods);
		}

		return "/site_mag/job_edit";
	}

	@RequestMapping(value = "/save", method = RequestMethod.POST)
	public String save(TdJob info, String[] hid_photo_name_show360, String __EVENTTARGET, String __EVENTARGUMENT,
