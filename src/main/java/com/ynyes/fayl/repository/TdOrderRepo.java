...
public interface TdOrderRepo extends PagingAndSortingRepository<TdOrder, Long>, JpaSpecificationExecutor<TdOrder> {
	...
	// 查找指定停车场已支付的订单
	List<TdOrder> findTop200ByDiyIdAndStatusIdOrderByOrderTimeDesc(Long id, Long statusId);
	
	Page<TdOrder> findByDiyIdAndStatusIdOrderByOrderTimeDesc(Long id, Long statusId,Pageable page);
	
	Page<TdOrder> findByDiyIdAndStatusIdOrderByFinishTimeDesc(Long id, Long statusId,Pageable page);
	...
	// 根据订单的支付方式查找一定时间段的订单
	List<TdOrder> findByThePayTypeAndStatusIdAndDiyIdAndFinishTimeBetweenOrderByFinishTimeDesc(Long thePayType,
			Long statusId, Long diyId, Date beginTime, Date finishTime);
	...
	List<TdOrder> findByStatusIdAndDiyIdAndFinishTimeBetweenOrderByFinishTimeDesc(Long statusId, Long diyId,
			Date beginTime, Date finishTime);
	...
	Page<TdOrder> findByFinishTimeBeforeAndOrderNumberContainingOrFinishTimeBeforeAndUsernameContainingOrFinishTimeBeforeAndDiyTitleContaining
		(Date date1 ,String keywords1 ,Date date2 ,String keywords2 , Date date3 , String keywords3 ,Pageable page);
	Page<TdOrder> findByOrderTimeAfterAndOrderNumberContainingOrOrderTimeAfterAndUsernameContainingOrOrderTimeAfterAndDiyTitleContaining
		(Date date1 ,String keywords1 ,Date date2 ,String keywords2 , Date date3 , String keywords3 ,Pageable page);
	Page<TdOrder> findByOrderTimeAfterAndFinishTimeBeforeAndOrderNumberContainingOrOrderTimeAfterAndFinishTimeBeforeAndUsernameContainingOrOrderTimeAfterAndFinishTimeBeforeAndDiyTitleContaining
	...
	Page<TdOrder> findByStatusIdAndFinishTimeBeforeAndOrderNumberContainingOrStatusIdAndFinishTimeBeforeAndUsernameContainingOrStatusIdAndFinishTimeBeforeAndDiyTitleContaining
	...
	Page<TdOrder> findByStatusIdAndOrderTimeAfterAndOrderNumberContainingOrStatusIdAndOrderTimeAfterAndUsernameContainingOrStatusIdAndOrderTimeAfterAndDiyTitleContaining
	(Long statusId1 ,Date date1, String keywords1 ,Long statusId2 ,Date date2 , String keywords2 ,Long statusId3 ,Date date3 , String keywords3 ,Pageable page);
	Page<TdOrder> findByStatusIdAndOrderTimeAfterAndFinishTimeBeforeAndOrderNumberContainingOrStatusIdAndOrderTimeAfterAndFinishTimeBeforeAndUsernameContainingOrStatusIdAndOrderTimeAfterAndFinishTimeBeforeAndDiyTitleContaining
